export class TemplateBoundary {
  ...
  createBoundary(options) {
    ...
    switch (type) {
      ...
      case "cone":
        ...
        break;
      default:
        console.error("Unknown boundary type:", this.type);
  ...
  updateBoundary(options) {
    let boundary = this.boundaries.find(
      b => b.activityUuid === options.activityUuid
    );
    if (boundary) {
...
class RectangleBoundary extends protoBoundary {
  ...
  updateBoundary(options) {
    ...
    console.log("Rectangle boundary updated:", this);
  }
}
class ConeBoundary extends protoBoundary {
  ...
  updateBoundary(options) {
    ...
    console.log("cone boundary updated:", this);
  }
}
